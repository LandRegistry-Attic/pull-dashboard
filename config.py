...
class Config(object):
    ...
    JENKINS_URL = 'http://52.16.47.1/api/json?pretty=true&depth=2&&tree=jobs[name,buildable,lastBuild[number,duration,timestamp,culprits[fullName],result,url,changeSet[items[msg,author[fullName]]]]]';
