...
class Config(object):
    ...
    JENKINS_URL = 'http://54.72.23.130/api/json?pretty=true&depth=2&&tree=jobs[name,lastBuild[number,duration,timestamp,culprits[fullName],result,url,changeSet[items[msg,author[fullName]]]]]';
